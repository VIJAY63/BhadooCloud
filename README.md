...
Info: Use AWS EC2 (1 Year Free), G Cloud (300$ for 1 Year Free), MS Azure (30 Days Free) for Bhadoo Cloud Installations.
...
Thanks [PraveenBhadooofficial](https://github.com/ParveenBhadooOfficial) 
